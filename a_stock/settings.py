...
FRONTEND_DIST_DIR = os.path.join(os.path.join(BASE_DIR, 'frontend'), 'dist')
...
ALLOWED_HOSTS = ['0.0.0.0', '192.168.31.135']
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [FRONTEND_DIST_DIR], # vue frontend
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = (
    ...
    # os.path.join(FRONTEND_DIST_DIR, 'static'), # vue frontend
)
